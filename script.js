document.addEventListener('DOMContentLoaded', () => {
    // Check if the current page is the customer reservation page (index.html)
    if (document.getElementById('reservationForm')) {
        ...
        const translations = {
            el: {
                ...
                customer_email_subject: 'Επιβεβαίωση Κράτησης - Pandrosou Garden Restaurant',
                customer_email_body: (name, date, time, guests) => `
                    Αγαπητέ/ή ${name},

                    Σας ευχαριστούμε για την κράτησή σας στο Pandrosou Garden Restaurant.
                    ...
                    Σας περιμένουμε!
                `,
                restaurant_email_subject: 'Νέα Κράτηση',
                restaurant_email_body: (name, phone, email, date, time, guests) => `
                    Νέα κράτηση στο Pandrosou Garden Restaurant:
